...
@Component({
  selector: 'page-tickets-edit',
  templateUrl: 'tickets-edit.html'
})

export class TicketsEditPage
{
	account = { id: 0 }
	lang = {
		errorFillFields: '',
	...
	saveChanges()
	{
		...
		{
			this.api.post('tickets-edit', { item: this.selectedItem, user: this.account.id }).subscribe((res: any) => {
